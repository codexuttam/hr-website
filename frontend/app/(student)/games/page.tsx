...
import {
  ...
  ArrowRight, Zap, Target, Brain, Gamepad2, Code2
} from 'lucide-react';
...
const games = [
    {
        ...
        description: 'Solve real coding problems in the browser. Submit your solution, run it against test cases, and get instant AI-powered feedback on your mistakes.',
        href: '/games/code-challenge',
        icon: Code2,
