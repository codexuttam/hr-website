...
const STUDENT_FEATURES = [
  ...
  },
  {
    ...
    desc: 'Plan your learning schedule',
  },
  {
    name: 'Brain Games',
    href: '/games',
...
const STUDENT_STATS = [
  { label: 'Resumes Created', icon: FileText, color: 'text-violet-600', bg: 'bg-violet-50 dark:bg-violet-900/20' },
  { label: 'Skills Assessed', icon: Target, color: 'text-emerald-600', bg: 'bg-emerald-50 dark:bg-emerald-900/20' },
  { label: 'Interview Preps', icon: Mic, color: 'text-rose-600', bg: 'bg-rose-50 dark:bg-rose-900/20' },
];

const ADMIN_STATS = [
  { label: 'Users Managed', icon: Users, color: 'text-blue-600', bg: 'bg-blue-50 dark:bg-blue-900/20' },
  { label: 'System Reports', icon: BarChart3, color: 'text-emerald-600', bg: 'bg-emerald-50 dark:bg-emerald-900/20' },
  { label: 'Platform Updates', icon: TrendingUp, color: 'text-violet-600', bg: 'bg-violet-50 dark:bg-violet-900/20' },
];
...
>>>>>>> 8c23812 (Add marketing skills and tools)
...
const UserDashboard: React.FC<UserDashboardProps> = ({ initialUser, initialStats }) => {
  ...
  const stats = isStudent ? STUDENT_STATS : ADMIN_STATS;
          ...
          {stats.map((stat, i) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <div className="text-2xl font-extrabold text-gray-900 dark:text-white">0</div>
